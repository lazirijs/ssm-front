<template>
  <div
    class="bg-white w-full sm:w-6/12 md:w-6/12 lg:w-4/12 flex flex-col items-center text-center gap-4 p-4 rounded-v m-auto mt-0">
    ...
    <h5 class="w-10/12 my-4 text-gray-600">if you don't receive an OTP, try to <a
        class="font-semibold underline decoration-solid">send again</a>, check your email spam page or try again later
    </h5>
  </div>
</template>
